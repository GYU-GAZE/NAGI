...
html[data-nagi-layout=network]{--nagi-ui-bg:#03131f;--nagi-ui-panel:#061c2b;--nagi-ui-text:#d8e7ff;--nagi-ui-font:monospace;--nagi-ui-font-size:15px;--nagi-thread-width:1040px;--nagi-line:color-mix(in srgb,var(--nagi-accent) 30%,transparent);--nagi-grid-image:none;scroll-padding-top:calc(var(--nagi-shell-height,140px) + 16px)}
...
html[data-nagi-layout=network] [data-nagi-layout-outer]{background:transparent!important;border:0!important;box-shadow:none!important}
html[data-nagi-layout=network] [data-nagi-layout-outer]::before,html[data-nagi-layout=network] [data-nagi-layout-outer]::after{background:none!important;box-shadow:none!important;pointer-events:none!important}
