...
:host([data-network-shell]) .bar{pointer-events:auto;width:100%;max-width:none;min-height:64px;gap:6px;padding:6px 16px;border:0;border-bottom:1px solid var(--nagi-line);border-radius:0;background:var(--nagi-ui-bg,#03131f);box-shadow:none;flex-wrap:wrap}
...
:host([data-brand=compact]) .brand-note{display:none}
...
:host([data-network-shell]) .bar .tool{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;min-width:58px;height:48px;padding:6px 8px;border:1px solid transparent;background:transparent;border-radius:5px;color:var(--nagi-ui-text);font-size:11px;white-space:nowrap;flex-shrink:0}
...
:host([data-network-shell]) .bar .answer-choice{margin-left:auto;display:flex;gap:12px;align-items:center;flex-shrink:0;border:1px solid var(--nagi-accent);background:var(--nagi-ui-panel);min-height:42px;padding:6px 12px}
:host([data-network-shell]) .identity img{width:32px;height:32px;border:1px solid var(--nagi-line);border-radius:4px}
:host([data-network-shell]) .identity .name{font-size:17px;max-width:160px;overflow:hidden;text-overflow:ellipsis}
:host([data-network-shell]) .context-strip{pointer-events:auto;box-sizing:border-box;display:flex;align-items:center;flex-wrap:wrap;gap:8px;padding:3px 16px;min-height:40px;border:1px solid var(--nagi-line);border-radius:0 0 6px 6px;background:var(--nagi-ui-bg,#03131f)}
...
@media(max-width:850px){:host([data-network-shell]) .bar .tool span{display:none}:host([data-network-shell]) .bar .tool{min-width:36px;width:36px}:host([data-network-shell]) .answer-label{display:none}}
@media(max-width:650px){:host([data-network-shell]) .bar{min-height:64px}:host([data-network-shell]) .brand{display:none}:host([data-network-shell]) .bar .tool{min-width:50px;font-size:10px;height:46px}.answer-label{display:none}:host([data-network-shell]) .identity .name{max-width:100px}.context-info{gap:6px;flex-wrap:wrap;overflow:visible}.chat-title{flex-basis:65%;min-width:0}.context-strip .context-badge{max-width:110px}.context-strip .context-project{max-width:100px}.prompt-nav{padding-left:0;border-left:0}.session-number{display:none}}
`;
